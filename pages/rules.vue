<template>
  <div>
    ...
    <h1>利用規約</h1>
    <p>
      この利用規約（以下、「本規約」といいます。）は、<a
        href="https://github.com/gyozabu"
        >餃子部</a
      >がこのウェブサイト上で提供するサービス（以下、「当サービス提供者」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
    </p>
    <h1>第1条（適用）</h1>
    <p>
